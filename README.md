...
<div align="center" style="text-align: center">
 <h1><b>Interactive Rating Component<b></h1>  
<p>Interactive Rating Component, Este proyecto es parte del desafío #100daysofprojects promovido por:</p> 
...
<p align="justify">Nuestra misión será crear un componente de calificación interactivo, usando HTML, CSS y JavaScript; y lograr que se parezca lo más posible al diseño.</p>

## Desafio

### _Los usuarios deberían poder:_
- Ver el diseño óptimo en pantallas grandes(1200px) y pequeñas(375px).
- Seleccionar un número para calificar.
- Ver un mensaje de agradecimiento con el número seleccionado.

### _Importante:_
- Agregar icono favicon al proyecto.
- Renombrar URL fácil de recordar (ej. interactive-rating-component).
- Agregar título al proyecto (ej. interactive-rating-component - Frontend Club).
...
`>>>` : [Opcion 01](https://frontend-club.hashnode.dev/interactive-rating-component)<br>
